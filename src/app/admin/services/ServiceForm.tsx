...
export default function ServiceForm({ service }: { service?: Service } = {}) {
  ...
  const handleNameChange = (name: string) => {
    setForm((p) => ({
      ...p,
      name,
      slug: slugEdited ? p.slug : toSlug(name),
    }));
  };
  ...
  const handleFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      fd.append("file", file);
      fd.append("folder", "temple/services");
    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl p-6 w-full max-w-2xl shadow-xl gold-border my-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Archana & Abhishekam"
                  />
                </div>
                <div>
                  <label className={labelClass}>
                    Slug *{" "}
                    <span className="text-foreground/40 font-normal text-xs">(URL path)</span>
                  </label>
                  <input
                    value={form.slug}
                    onChange={(e) => {
              ...
              <div>
                <label className={labelClass}>
                  Short Description{" "}
                  <span className="text-foreground/40 font-normal">(shown on listing cards)</span>
                </label>
                <textarea
              ...
              <div>
                <label className={labelClass}>
                  Full Description{" "}
                  <span className="text-foreground/40 font-normal">(shown on detail page)</span>
                </label>
                <textarea
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="svc-active" className="text-sm text-maroon/80">
