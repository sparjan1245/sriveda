...
export default function SponsorTierActions({ id, name }: { id: string; name: string }) {
  ...
  const del = async () => {
    ...
    setBusy(true);
    await fetch(`/api/sponsor-tiers/${id}`, { method: "DELETE" });
    setBusy(false);
    router.refresh();
  };
  ...
  return (
    <div className="flex items-center gap-1">
      <a
        href={`/admin/sponsor-tiers/${id}/edit`}
