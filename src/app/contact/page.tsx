  ...
  return (
    <div>
      ...
      <section className="relative h-64 md:h-80 flex items-center justify-center overflow-hidden">
        <Image src={IMAGES.temple1} alt="Contact Us" fill className="object-cover" />
        <div className="absolute inset-0" style={{ background: "rgba(107,15,26,0.75)" }} />
        <div className="relative z-10 text-center px-4">
          <p className="text-gold font-cinzel text-sm uppercase tracking-widest mb-2">Reach Out</p>
          <h1 className="font-cinzel font-bold text-4xl md:text-5xl text-white">Contact Us</h1>
        </div>
      </section>
